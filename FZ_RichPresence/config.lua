Citizen.CreateThread(function()
	while true do
        ...
        SetDiscordRichPresenceAssetSmallText('discord.gg/YourInvite')
        SetDiscordRichPresenceAction(0, "Jouer 🎮", "fivem://connect/cfx.re/join/YourIDServer")
        SetDiscordRichPresenceAction(1, "Discord 🔔", "https://discord.gg/YourInvite")
		Citizen.Wait(60000)
	end
end)
Citizen.CreateThread(function()
